...
const ModalForm: React.FC<ModalWrapperProps> = ({clickFunc, isModalVisible }) => {
...
function FormFinal()
{
    ...
    return (
<>
            <button onClick={toggleModal}><img src="../assets/svg/feedback.svg"/> </button>
            <ModalForm
